      ...
      <div className="flex flex-col">
        <div className="flex flex-row items-center justify-around">
          <img
            ...
            alt="imagePadi"
          />
          <div className="flex flex-col items-start w-[204px] md:w-[312px] lg:w-[610px] 2xl:w-[700px]">
        ...
        <div className="flex flex-row row-auto justify-around items-center">
          <div className="flex flex-col items-start w-[349px] md:w-[383px] lg:w-[500px] 2xl:w-[800px]">
            <div className="font-inter font-bold text-black  text-[16px] md:text-[28px] lg:text-[50px] text-start">
              How can we help farmers
            </div>
            <div className="h-[5px] lg:h-[24px]"></div>
            <div className="font-inter font-medium text-black text-start text-[11px] md:text-[14px] lg:text-[25px] lg:leading-normal w-full ">
            ...
            <div>
              <div className="flex flex-row row-auto items-center justify-between">
                <img
                  ...
                  alt="profile"
                />
                <div className="w-[10px] lg:w-[50px]"></div>
                <div className="flex flex-col items-start">
                  <div className="font-inter font-bold text-black text-[12px] md:text-[16px] lg:text-[25px]">
                    Loren ipsum ceunah
                  </div>
                  <div className="font-inter font-medium text-black text-start text-[10px] md:text-[14px] lg:text-[20px] w-full">
