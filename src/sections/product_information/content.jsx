    ...
    <div className="flex flex-col">
      ...
      <div id="informationProduct">
        ...
        <div className="flex flex-col items-start">
          ...
          <div className="flex flex-col items-center justify-center w-[110px] h-[110px] md:w-[200px] md:h-[200px] lg:w-[300px] lg:h-[300px] px-[24px] py-[28px] border-4 border-gray border-opacity-30 border-dashed rounded-md">
            <img
              src={UploadImageIcon}
        ...
        <div className="flex flex-row md:w-full 2xl:w-[1500px] justify-between items-center py-2">
          <div className="font-inter font-semibold text-[14px] md:text-[18px] lg:text-[25px] text-black">
            Metode Pertanian
          </div>
          <DropdownValue
            options={options}
            className={"relative w-[150px] md:w-[190px] lg:w-[294px] 2xl:w-[100px]"}
            value={"Select"}
            placeholder={"Select"}
          />
        </div>
            ...
            <form className="flex items-center justify-start ">
              <span className="flex items-center justify-start rounded-md ring-1 ring-gray p-5 w-full ring-opacity-50 focus:ring-gray">
                <textarea
                  ...
                  className="font-inter font-medium focus:outline-none text-[12px] md:text-[16px] lg:text-[24px] h-[67px] lg:h-[171px] resize-none w-[325px] md:w-[627px] lg:w-[860px] 2xl:w-[1855px]"
                  readOnly={false}
                  name={"deskripsi"}
        ...
        <div className="flex flex-row md:flex-col justify-between md:items-start items-center">
          ...
          <TextfieldProfile
            ...
            type={"text"}
            className={
              "font-inter font-medium text-[14px] md:text-[16px] lg:text-[26px] focus:outline-none w-[130px] md:w-[627px] lg:w-[860px] 2xl:w-[1855px]"
            }
          />
        </div>
        <div className="pb-3">
        ...
        <div className="flex flex-row md:w-full 2xl:w-[1500px] justify-between items-center">
          <div className="font-inter font-semibold text-[14px] md:text-[18px] text-black text-start">
      ...
      <div id="information farmer">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="flex flex-row w-full 2xl:w-[1500px] justify-between">
              <DropdownValue
                options={options}
                placeholder={"Provinsi"}
                textColor={"text-gray"}
                value={""}
                className={"relative w-[102px] md:w-[184px] lg:w-[294px] 2xl:w-[100px]"}
              />
              <DropdownValue
                options={options}
                placeholder={"Kota"}
                textColor={"text-gray"}
                value={""}
                className={"relative w-[109px] md:w-[184px] lg:w-[294px] 2xl:w-[100px]"}
              />
              <DropdownValue
                options={options}
                ...
                textColor={"text-gray"}
                value={""}
                className={"relative w-[118px] md:w-[184px] lg:w-[294px] 2xl:w-[100px]"}
              />
            </div>
          </div>
        ...
        <div className="flex flex-row justify-start pb-[42px]">
          <button className="px-8 py-1 md:px-12 md:py-2 lg:px-20 lg:py-2 2xl:px-30 2xl:py-3 bg-white border border-primary text-primary rounded-md font-inter font-semibold text-[16px] md:text-[22px]">
            Cancel
          </button>
          <div className="w-2 md:w-5 2xl:w-10"></div>
          <button className="px-10 py-1 md:px-12 md:py-2 lg:px-20 lg:py-2 2xl:px-30 2xl:py-3 bg-primary  text-white rounded-md font-inter font-semibold text-[16px] md:text-[22px]">
            Save
          </button>
        </div>
      </div>
